...
import com.bertha.sunny.weather.Current;
import com.bertha.sunny.weather.Day;
import com.bertha.sunny.weather.Forecast;
...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final double latitude = 47.22;
        final double longitude = 8.32;
                ...
                public void onResponse(Response response) throws IOException {
                    ...
                    try {
                        ...
                        if (response.isSuccessful()) {
                            mForecast = parseForecastDetails(jsonWeatherData);
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    updateDisplay();
    ...
    private Current getCurrentWeatherDetails(String jsonWeatherData) throws JSONException {
